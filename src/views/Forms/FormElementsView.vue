    ...
    <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
      <div class="flex flex-col gap-9">
        ...
        <DefaultCard cardTitle="Datos Generales">
          ...
          <Form @submit="submit" :validation-schema="schema" class="flex flex-row gap-5.5 p-6.5 justify-between">
            <div class="flex flex-col">
              <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                Nombre
              </label>
              <Field name="nameTicket"
                class="w-full rounded-lg border-[1.5px] text-black border-stroke bg-transparent py-3 px-5 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
              <ErrorMessage name="nameTicket" />
            </div>
            ...
            <div class="flex flex-col">
              ...
              <Field name="typeService" as="select">
            ...
            <div class="flex flex-col">
              ...
              <Field name="descriptionTicket"
                class="w-full rounded-lg border-[1.5px] text-black border-stroke bg-transparent py-3 px-5 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
              <ErrorMessage name="descriptionTicket" />
            </div>
          </Form>
        ...
        <DefaultCard cardTitle="Datos del cliente">
          <div class="flex flex-row gap-5.5 p-6.5 justify-between">
            <div>
              <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                Nombre
              </label>
          ...
          <div class="flex flex-col gap-5.5 p-6.5">
            ...
            <div>
              ...
              <textarea rows="6" placeholder="Active textarea"
                class="w-full rounded-lg border-[1.5px] text-black border-primary bg-transparent py-3 px-5 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:bg-form-input"></textarea>
            </div>
            ...
            <div>
              ...
              <textarea rows="6" disabled placeholder="Disabled textarea"
                class="w-full rounded-lg border-[1.5px] text-black border-stroke bg-transparent py-3 px-5 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary dark:disabled:bg-black"></textarea>
            </div>
          </div>
        </DefaultCard>
        <!-- Textarea Fields End -->
